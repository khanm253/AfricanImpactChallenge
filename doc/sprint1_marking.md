...
## Tracking on Jira  (max 20 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1 
    Comment: Some tasks are not matching on Jira.
...
Your Mark: 2
  ...
  - Branch Naming (max 2 marks)
    ...
    Your Mark: 2
	Commnet: Each issue should have their own branch with the formated branch name where we mentioned in the tutorial. If sub-task is being assigned to the same person, you can work under multiple sub-task for the same user story in the same branch.
Tracking on Jira Total Mark: 15 / 20
